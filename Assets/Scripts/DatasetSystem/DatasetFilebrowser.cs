...
public class DatasetFilebrowser : MonoBehaviour
{
	// Warning: paths returned by FileBrowser dialogs do not contain a trailing '\' character
	// Warning: FileBrowser can only show 1 dialog at a time

	private SpatialDataset loadedDataset;

	
	void Start()
	{

		loadedDataset = GetComponent<SpatialDataset>();
	...
	void OnFilesSelected( string[] filePaths )
	{
		...
		if (filePaths.Length > 1) Debug.Log("Only one file at a time!");
