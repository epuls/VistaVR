...
public struct CellSpawnerComponent : IComponentData
{
    ...
    public Entity ClusterEntityPrefab;
    public Entity ClusterParentEntityPrefab;
}
...
public class CellSpawnerBaker : Baker<CellSpawnerAuthoring>
{
    public override void Bake(CellSpawnerAuthoring authoring)
    {
        ...
        if (authoring.clusterPrefab == null)
        {
            Debug.LogError("CellSpawnerAuthoring: 'Cluster Prefab' field is not assigned. Baking cannot proceed.", authoring.gameObject);
            return; 
        }
        ...
        try
        {
            ...
            var entityPrefabClust = GetEntity(authoring.clusterPrefab, TransformUsageFlags.Dynamic);
            var entityPrefabClustParent = GetEntity(authoring.clusterParentPrefab, TransformUsageFlags.Dynamic);
            ...
            AddComponent(spawnerEntity, new CellSpawnerComponent
            {
                ...
                ClusterEntityPrefab = entityPrefabClust,
                ClusterParentEntityPrefab = entityPrefabClustParent
            });
